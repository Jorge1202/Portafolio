        ...
        <section id="skills" className="skills section-bg">
            <div className="container">
                <div className="section-title">
                    <h2>Skills</h2>
                    <p>
                        A lo largo de mi carrera, he adquirido una amplia gama
                        de habilidades técnicas que me permiten abordar
                        proyectos complejos con confianza y creatividad. A
                        continuación, te presento mis habilidades principales y
                        mi experiencia en el desarrollo de aplicaciones web.
                    </p>
                </div>
                ...
                <div className="row skills-content">
                    <div className="col-lg-6" data-aos="fade-up">
                        ...
                        <div className="progress">
                            <span className="skill">
                                METODOLOGÍA SCRUM <i className="val">80%</i>
                            </span>
                            <div className="progress-bar-wrap">
                    ...
                    <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100" > 
                        ...
                        <div className="progress">
                            <span className="skill">
                                POSTGRESQL <i className="val">55%</i>
                            </span>
                            <div className="progress-bar-wrap">
                                <div className="progress-bar" role="progressbar" aria-valuenow={55} aria-valuemin={0} aria-valuemax={100}></div>
                            </div>
